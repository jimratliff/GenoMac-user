...
PERM_CHESSVISION_AI_USER_WANTS_IT="PERM_chessvision_ai_user_wants_it"
...
PERM_HIARCS_CHESS_EXPLORER_PRO_USER_WANTS_IT="PERM_hiarcs_chess_explorer_pro_user_wants_it"
...
export_and_report PERM_CHESSVISION_AI_USER_WANTS_IT
...
export_and_report PERM_HIARCS_CHESS_EXPLORER_PRO_USER_WANTS_IT
