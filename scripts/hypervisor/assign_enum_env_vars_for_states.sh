...
PERM_WITCH_LICENSE_FILES_HAVE_BEEN_TRANSFERRED="PERM_witch_license_files_have_been_transferred"
...
export_and_report PERM_WITCH_LICENSE_FILES_HAVE_BEEN_TRANSFERRED
