...
PERM_FINDER_HAS_BEEN_BOOTSTRAPPED="PERM_finder_has_been_bootstrapped"
...
PERM_WATERFOX_EXTENSION_YOUTUBE_WANTS_TO_CONFIGURE="PERM_waterfox_extension_youtube_wants_to_configure"
...
export_and_report PERM_FINDER_HAS_BEEN_BOOTSTRAPPED
...
export_and_report PERM_WATERFOX_EXTENSION_YOUTUBE_WANTS_TO_CONFIGURE
