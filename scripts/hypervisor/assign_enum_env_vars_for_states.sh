...
PERM_APPLE_MAIL_APP_USER_WANTS_IT="PERM_apple_mail_app_user_wants_it"
...
PERM_USER_IS_A_GENOMAC_DEVELOPER="PERM_user_is_a_genomac_developer"
...
export_and_report PERM_APPLE_MAIL_APP_USER_WANTS_IT
...
export_and_report PERM_USER_IS_A_GENOMAC_DEVELOPER
