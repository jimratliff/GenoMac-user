...
safe_source "${GMU_SETTINGS_SCRIPTS}/interactive_configure_downie.sh"
...
safe_source "${GMU_SETTINGS_SCRIPTS}/interactive_configure_notion.sh"
...
safe_source "${GMU_SETTINGS_SCRIPTS}/set_mail_app_settings.sh"
