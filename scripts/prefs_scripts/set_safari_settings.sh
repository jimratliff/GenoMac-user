...
sudo defaults write com.apple.Safari WebKitPreferences.tabFocusesLinks -bool true;success_or_not
report_adjust_setting "2 of 2: WebKitTabToLinksPreferenceKey"
sudo defaults write com.apple.Safari WebKitTabToLinksPreferenceKey -bool true;success_or_not
...
sudo defaults write com.apple.Safari CommandClickMakesTabs -bool true;success_or_not

report_adjust_setting "Do NOT make a new tab/window active"
sudo defaults write com.apple.Safari OpenNewTabsInFront -bool false;success_or_not
...
sudo defaults write com.apple.Safari BlockStoragePolicy -int 2;success_or_not
report_adjust_setting "2 of 3: WebKitPreferences.storageBlockingPolicy"
sudo defaults write com.apple.Safari WebKitPreferences.storageBlockingPolicy -int 1;success_or_not
report_adjust_setting "3 of 3: WebKitStorageBlockingPolicy"
sudo defaults write com.apple.Safari WebKitStorageBlockingPolicy -int 1;success_or_not

report_action_taken "Warn if visit a fraudulent site"
report_adjust_setting "1 of 2: WarnAboutFraudulentWebsites"
sudo defaults write com.apple.Safari WarnAboutFraudulentWebsites -bool true;success_or_not
report_adjust_setting "2 of 2: com.apple.Safari.SafeBrowsing » SafeBrowsingEnabled"
sudo defaults write com.apple.Safari.SafeBrowsing SafeBrowsingEnabled -bool true;success_or_not

report_action_taken "Show features for web developers"
report_adjust_setting "1 of 5: IncludeDevelopMenu"
sudo defaults write com.apple.Safari IncludeDevelopMenu -bool true;success_or_not
report_adjust_setting "2 of 5: MobileDeviceRemoteXPCEnabled"
sudo defaults write com.apple.Safari MobileDeviceRemoteXPCEnabled -bool true;success_or_not
report_adjust_setting "3 of 5: WebKitDeveloperExtrasEnabledPreferenceKey"
sudo defaults write com.apple.Safari WebKitDeveloperExtrasEnabledPreferenceKey -bool true;success_or_not
report_adjust_setting "4 of 5: WebKitPreferences.developerExtrasEnabled"
sudo defaults write com.apple.Safari WebKitPreferences.developerExtrasEnabled -bool true;success_or_not
report_adjust_setting "5 of 5: Safari.SandboxBroker: IncludeDevelopMenu"
sudo defaults write com.apple.Safari.SandboxBroker ShowDevelopMenu -bool true;success_or_not

report_adjust_setting "Reveal internal debug menu"
sudo defaults write com.apple.Safari IncludeInternalDebugMenu -bool true;success_or_not
