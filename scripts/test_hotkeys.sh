...
safe_source "${PREFS_FUNCTIONS_DIR}/test_symbolic_hotkeys.sh"

############################## BEGIN SCRIPT PROPER #############################
report_start_phase 'Begin test of symbolic hotkeys'

test_symbolichotkeys

report_end_phase 'End test of symbolic hotkeys'
