...
function test_launch_app_and_prompt_user_to_act() {
  ...
  launch_app_and_prompt_user_to_act --show-doc "${GENOMAC_USER_LOCAL_DOCUMENTATION_DIRECTORY}/TextExpander_how_to_configure.md" "$BUNDLE_ID_TEXTEDIT" "Please do the thing"
