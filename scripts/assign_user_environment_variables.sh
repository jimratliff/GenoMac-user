...
USER_SPECIFIC_OBJECT_TO_ALIAS_TO_THE_DOCK_FILENAME="objects_to_alias_to_the_Dock.jsonl"
USER_SPECIFIC_OBJECT_TO_ALIAS_TO_THE_DOCK_FILE="${USER_SPECIFIC_META_DIRECTORY}/${USER_SPECIFIC_OBJECT_TO_ALIAS_TO_THE_DOCK_FILENAME}"
