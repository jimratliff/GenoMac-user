...
SPACEJUMP_LICENSE_KEY_FILE="$GENOMAC_USER_SHARED_PREFERENCES_DIRECTORY/SpaceJump/License_key/SpaceJump_license_key.txt"
...
USER_SPECIFIC_OBJECTS_TO_ALIAS_TO_THE_DOCK_FILENAME="objects_to_alias_to_the_Dock.jsonl"
USER_SPECIFIC_OBJECTS_TO_ALIAS_TO_THE_DOCK_FILE="${USER_SPECIFIC_META_DIRECTORY}/${USER_SPECIFIC_OBJECTS_TO_ALIAS_TO_THE_DOCK_FILENAME}"

USER_SPECIFIC_FINDER_SIDEBAR_FAVORITES_FILENAME="finder_sidebar_favorites_name_path_pairs.jsonl"
USER_SPECIFIC_FINDER_SIDEBAR_FAVORITES_FILE="${USER_SPECIFIC_META_DIRECTORY}/${USER_SPECIFIC_FINDER_SIDEBAR_FAVORITES_FILENAME}"

INTERNET_ACCOUNTS_MARKDOWN_PAGE_FILENAME="Internet_Accounts_how_to_configure_accounts.md"
USER_SPECIFIC_INTERNET_ACCOUNTS_SPECIFICATIONS_FILE="${USER_SPECIFIC_META_DIRECTORY}/${INTERNET_ACCOUNTS_MARKDOWN_PAGE_FILENAME}"

PROTON_DRIVE_SPECIFICATION_MARKDOWN_PAGE_FILENAME="Proton_Drive_how_to_configure.md"
USER_SPECIFIC_PROTON_DRIVE_SPECIFICATIONS_FILE="${USER_SPECIFIC_META_DIRECTORY}/${PROTON_DRIVE_SPECIFICATION_MARKDOWN_PAGE_FILENAME}"
