...
function set_finder_settings() {
  ...
  # Show Tab Bar
  report_adjust_setting "Show tab bar"
  defaults write $finder_domain "NSWindowTabbingShoudShowTabBarKey-com.apple.finder.TBrowserWindow" -bool true ; success_or_not
