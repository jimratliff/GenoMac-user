...
GMU_SESH_BASIC_SETTINGS_HAVE_BEEN_IMPLEMENTED="GMU_SESH_BASIC_SETTINGS_HAVE_BEEN_IMPLEMENTED"
...
export_and_report GMU_SESH_BASIC_SETTINGS_HAVE_BEEN_IMPLEMENTED
