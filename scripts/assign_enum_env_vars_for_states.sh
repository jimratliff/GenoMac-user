...
GMU_PERM_USER_WILL_USE_DROPBOX="GMU_PERM_USER_WILL_USE_DROPBOX"
GMU_PERM_USER_WILL_USE_MICROSOFT_WORD="GMU_PERM_USER_WILL_USE_MICROSOFT_WORD"
GMU_PERM_SHOW_DRIVES_ON_DESKTOP="GMU_PERM_SHOW_DRIVES_ON_DESKTOP"
...
GMU_SESH_BASIC_BOOTSTRAP_OPERATIONS_HAVE_BEEN_PERFORMED="GMU_SESH_BASIC_BOOTSTRAP_OPERATIONS_HAVE_BEEN_PERFORMED"
...
export_and_report GMU_SESH_BASIC_BOOTSTRAP_OPERATIONS_HAVE_BEEN_PERFORMED
