...
GMU_SESH_SHOW_DRIVES_ON_DESKTOP_HAS_BEEN_IMPLEMENTED="GMU_PERM_SHOW_DRIVES_ON_DESKTOP_HAS_BEEN_IMPLEMENTED"
...
export_and_report GMU_SESH_SHOW_DRIVES_ON_DESKTOP_HAS_BEEN_IMPLEMENTED
