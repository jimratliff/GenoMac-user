...
GMU_PERM_DROPBOX_HAS_BEEN_AUTHENTICATED="GMU_PERM_DROPBOX_HAS_BEEN_AUTHENTICATED"
...
GMU_PERM_TEXTEXPANDER_HAS_BEEN_AUTHENTICATED="GMU_PERM_TEXTEXPANDER_HAS_BEEN_AUTHENTICATED"
...
export_and_report GMU_PERM_DROPBOX_HAS_BEEN_AUTHENTICATED
...
export_and_report GMU_PERM_TEXTEXPANDER_HAS_BEEN_AUTHENTICATED
