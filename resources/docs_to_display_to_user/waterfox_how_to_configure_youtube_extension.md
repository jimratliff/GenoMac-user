# How to configure the Enhancer for YouTube™ extension for the Waterfox web browser
...
- Row 1 of controls:
  - Item 1: Loop mode (“Click or right-click to toggle the loop mode”)
    - ❑ Turn OFF ❌ this item
  - Item 3: Volume booster (“Click to toggle the volume booster”)
    - ❑ Turn OFF ❌ this item
- Row 2 of controls
  - Item 1: Use mouse wheel to control playback speed (“Use the mouse wheel to control
