# How to configure the Markdown Viewer Webext extension for the Waterfox web browser
...
## Enable Markdown Viewer Webext
- Markdown Viewer Webext
  - ❑ Toggle the switch to ON ✅
 
## Open the preferences for Markdown Viewer Webext
- ❑ Context-click on the “…” button to the right of the switch you just toggled, and select “Preferences”

## Selectively change some of the switches regarding markdown-it plugins
- ❑ “markdown-it-emojis”: Switch OFF (✅ → ❌)
- ❑ “markdown-it-footnote”: Switch ON (❌ → ✅)
- ❑ “markdown-it-fancy-lists”: Switch ON (❌ → ✅)
