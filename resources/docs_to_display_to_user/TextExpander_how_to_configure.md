# How to configure TextExpander

## Launch TextExpander
- Make TextExpander the active app. (The Hypervisor should have launched TextExpander for you already.)

## Log into the TextExpander service
### Log in to TextExpander
- Log in using email/password from the “TextExpander” item in 1Password
...
### Adjust preferences for TextExpander.app
- TextExpander.app
  - Preferences
