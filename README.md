...
Note that *only USER_CONFIGURER* is authorized to use Homebrew to install applications (or update them, unless they have auto-upgrade mechanisms).[^HOMEBREW_IN_MULTIUSER_ENVIRONMENT]<sup>,</sup>[^HOMEBREW_UPDATE_IS_DIFFERENT]
