...
[^slightly_sensitive_data]: To be clear, secrets are *not* exposed in GenoMac-private. GenoMac-private contains user *names*, volume names, and attributes assigned to users, which attributes can indicate particular applications or other characteristics of a user’s workflow.
